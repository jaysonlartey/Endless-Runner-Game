...
import { loadSlimeSprites, purpleSlimeSpriteConfig } from "../../assets/slimeSpriteConfig.js";
...
export default class PurpleSlime extends Enemy {
    constructor(x, y) {
        ...
        this.sprites = loadSlimeSprites(images.get(ImageName.PurpleSlime), purpleSlimeSpriteConfig);
